<?php 
include("header.php");
   $_HEADING = "Update About Services Profile";   
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>About Services Management</h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="breadcrumb-item"><a href="#"><i class="fa fa-files-o"></i> About Services Management</a></li>
	...
	<div class="box">
       ...
       <?php } ?>
			<div class="row">
				<div class="col">
					<form action="action/about_services.php?subview=update&id=<?php echo $offer['id'];?>" method="post" enctype="multipart/form-data">
