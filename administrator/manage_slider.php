                 ...
                 <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <label for="discount">Image only upload(1350*450)</label>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="controls">
                        <input type="text" name="link" class="form-control" value="<?php echo $row['link']?>"> </div>
                      </div> 
      ...
      <form action="action/manage_slider.php?subview=add" method="post" enctype="multipart/form-data">
        <div class="modal-body">
         <div class="form-group">
           <div class="row">
            <div class="col-sm-12">
              <h5>Slider Image upload(1350*450)<span class="text-danger">*</span></h5>
              <div class="controls">
                <input type="file" class="form-control" name="image" id="image"/>
              </div>
            </div>
