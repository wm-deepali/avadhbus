				...
				<!-- <form novalidate>
					...
					<div class="form-group">
					 ...
					 <div class="col-sm-12">
						...
						<div class="col-sm-6">
						<h5>Email Address-1<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" class="form-control" name="email" value="<?php echo $offer['email']?>">
						</div>
						</div>
                          <!--<div class="col-sm-6">
						<h5>Email Address-2<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" class="form-control" name="email1" value="<?php echo $offer['email1']?>">
						</div>
						</div>-->
						<!--<div class="col-sm-6">
						<h5>Whataap Number<span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" class="form-control" name="wmob" value="<?php echo $offer['wmob']?>">
						</div>
						</div>-->
                      <div class="col-sm-6">
