...
<div class="box">
  <div class="box-header">
    ...
    <button class="btn btn-primary pull-right" data-target="#add_gal" data-toggle="modal">Add New Bus</button>
  </div>
  <!-- /.box-header -->
      ...
      <tbody>
       <?php $i=1; while($row = mysqli_fetch_assoc($result)){?>
         <tr>
          ...
          <td><img src="gallery/<?php echo $row['image_name1'];?>" height="60px" width="120px" class="rounded-circle img-sm"/></td>
          <?php 
              ...
              <form action="action/manage_gallery.php?subview=update&id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                 ...
                 <div class="col-sm-12">
                  ...
                  <div class="controls">
                   <input type="text" class="form-control" name="text" id="text" value="<?= $row['content']; ?>" />
                 </div>
               </div>
               <div class="col-sm-12">
                <h5> <label for="discount">Exterior</label><span class="text-danger">*</span></h5>
                <div class="controls">
                  <div class="form-group">
                ...
                <div class="col-sm-12">
                  <h5> <label for="discount">Interior</label><span class="text-danger">*</span></h5>
                  <div class="controls">
                    <div class="form-group">
                      <?php if($row['image_name']!=""){?>      
                        <img src="gallery/<?php echo $row['image_name1']?>" height="100" width="100"/>
                      <?php } ?>
                    </div>
                    <div class="form-group">

                      <input type="file" class="form-control" name="image1" id="image"/>
                      <input type="hidden" class="form-control" name="added_image" value="gallery/<?php echo $row['image_name']?>"/>
                      <input type="hidden" class="form-control" name="added_image1" value="gallery/<?php echo $row['image_name1']?>"/>
                    </div> </div>
                  </div>
                </div>
              </div>
      ...
      <form action="action/manage_gallery.php?subview=add" method="post" enctype="multipart/form-data">
        <div class="modal-body">
         ...
         <div class="col-sm-12">
          ...
          <div class="controls">
           <input type="text" class="form-control" name="text" id="title"  placeholder="Content"/>
         </div>
       </div>
       <div class="col-sm-12">
        <h5>Exterior<span class="text-danger">*</span></h5>
        <div class="controls">
         <input type="file" class="form-control" name="image" id="image"/>
       </div>
     </div>
     <div class="col-sm-12">
      <h5>Interior<span class="text-danger">*</span></h5>
      <div class="controls">
